    ...
    public class DbContextScope : IDbContextScope
    {
        ...
        public void RefreshEntitiesInParentScope(IEnumerable entities)
        {
            ...
            foreach (var contextInCurrentScope in _dbContexts.InitializedDbContexts.Values)
            {
                ...
                {
                    var entry = correspondingParentContext.Entry(toRefresh);
...
" + Environment.StackTrace;
        ...
        private static readonly AsyncLocal<Dictionary<string, InstanceIdentifier>> _asyncLocalDictionary = new AsyncLocal<Dictionary<string, InstanceIdentifier>>();
        ...
        internal static void SetAmbientScope(DbContextScope newAmbientScope)
        {
            ...
            {
                _asyncLocalDictionary.Value = new Dictionary<string, InstanceIdentifier>();
            }
            InstanceIdentifier current;
            _asyncLocalDictionary.Value.TryGetValue(AmbientDbContextScopeKey, out current);
            ...
            _asyncLocalDictionary.Value[AmbientDbContextScopeKey] = newAmbientScope._instanceIdentifier;
        ...
        internal static void RemoveAmbientScope()
        {
            ...
            _asyncLocalDictionary.Value[AmbientDbContextScopeKey] = null;
        ...
        internal static DbContextScope GetAmbientScope()
        {
            ...
            _asyncLocalDictionary.Value.TryGetValue(AmbientDbContextScopeKey, out instanceIdentifier);
